...
<div class="ibox">
    <div class="ibox-title">
        ...
        <div class="ibox-tools">
            <a href="/user/userAdd/0" class="btn btn-primary btn-sm">
...
<table class="table table-hover table-bordered ">
    ...
    <c:forEach var="user" items="${userList}">
        <tr>
            ...
            <td>
                <a class="label label-success" href="/user/userAdd/${user.id}"><i class="fa fa-edit"></i>编辑</a>
                <a class="label label-danger" href="javascript:void(0);" onclick="javascript:Delete('/user/userDelete/${user.id}');"><i class="fa fa-times"></i>删除</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
